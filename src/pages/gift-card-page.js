...
export default class GiftCardPage extends BasePage {
    ...
    enter_all_values(giftCardObject) {
        ...
        this.enterValue(lastName_topSection(), giftCardObject.lastName)
        ...
        this.enterValue(lastName_billingSection(), giftCardObject.billingSection.lastName)
        ...
        this.enterValue(stateInput(), giftCardObject.billingSection.stateCode)
        this.selectDropdownOption(1, giftCardObject.billingSection.country)
    ...
    verify_all_values(object) {
        this.waitElementToDisappear(saveCreateGiftCard())
